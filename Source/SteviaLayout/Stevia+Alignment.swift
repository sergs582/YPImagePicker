 ...
 */
@discardableResult
func align(horizontally views: UIView...) -> [UIView] {
 ...
 */
func align(vertically views: UIView...) {
    align(vertically: views)
}

@available(*, deprecated, renamed: "align(vertically:)")
func alignVertically(_ views: UIView...) {
    align(vertically: views)
}
...
/** Aligns the center of two views
 ...
 ```
 */
func alignCenter(_ v1: UIView, with v2: UIView) {
 ...
 */
func alignHorizontally(_ v1: UIView, with v2: UIView, offset: Double = 0) {
 ...
 */
func alignVertically(_ v1: UIView, with v2: UIView, offset: Double = 0) {
 ...
 */
@discardableResult
func align(tops views: UIView...) -> [UIView] {
    return align(tops: views)
}

@available(*, deprecated, renamed: "align(tops:)")
@discardableResult
func alignTops(_ views: UIView...) -> [UIView] {
    return align(tops: views)
}
 ...
 */
@discardableResult
func align(bottoms views: UIView...) -> [UIView] {
    return align(bottoms: views)
}

@available(*, deprecated, renamed: "align(bottoms:)")
@discardableResult
func alignBottoms(_ views: UIView...) -> [UIView] {
    return align(bottoms: views)
}
 ...
 */
@discardableResult
func align(lefts views: UIView...) -> [UIView] {
    return align(lefts: views)
}

@available(*, deprecated, renamed: "align(lefts:)")
@discardableResult
func alignLefts(_ views: UIView...) -> [UIView] {
    return align(lefts: views)
}
 ...
 */
@discardableResult
func align(rights views: UIView...) -> [UIView] {
    return align(rights: views)
}

@available(*, deprecated, renamed: "align(rights:)")
@discardableResult
func alignRights(_ views: UIView...) -> [UIView] {
    return align(rights: views)
}
...
*/
@discardableResult
func align(leadings views: [UIView]) -> [UIView] {
...
*/
@discardableResult
func align(trailings views: [UIView]) -> [UIView] {
...
@discardableResult
func align(_ attribute: NSLayoutConstraint.Attribute, views: [UIView]) -> [UIView] {
    for (i, v) in views.enumerated() where views.count > i+1 {
        let v2 = views[i+1]
