...
prefix operator |
@discardableResult
prefix func | (p: UIView) -> UIView {
    p.leading(0)
}

postfix operator |
@discardableResult
postfix func | (p: UIView) -> UIView {
    p.trailing(0)
}
...
@discardableResult
func ~ (left: UIView, right: Double) -> UIView {
    left.height(right)
}

@discardableResult
func ~ (left: UIView, right: CGFloat) -> UIView {
    left ~ Double(right)
}

@discardableResult
func ~ (left: UIView, right: Int) -> UIView {
    left ~ Double(right)
}

@discardableResult
func ~ (left: UIView, right: SteviaPercentage) -> UIView {
    left.height(right)
}

@discardableResult
func ~ (left: UIView, right: SteviaFlexibleMargin) -> UIView {
    left.height(right)
}
...
prefix operator |-
@discardableResult
prefix func |- (p: Double) -> SideConstraint {
...
@discardableResult
prefix func |- (p: CGFloat) -> SideConstraint {
    |-Double(p)
}

@discardableResult
prefix func |- (p: Int) -> SideConstraint {
    |-Double(p)
}

@discardableResult
prefix func |- (v: UIView) -> UIView {
    v.leading(8)
}

postfix operator -|
@discardableResult
postfix func -| (p: Double) -> SideConstraint {
    var s = SideConstraint()
    s.constant = p
    return s
}
...
@discardableResult
postfix func -| (p: CGFloat) -> SideConstraint {
    Double(p)-|
}

@discardableResult
postfix func -| (p: Int) -> SideConstraint {
    Double(p)-|
}

@discardableResult
postfix func -| (v: UIView) -> UIView {
    v.trailing(8)
}
...
@discardableResult
func - (left: UIView, right: Double) -> PartialConstraint {
...
@discardableResult
func - (left: UIView, right: CGFloat) -> PartialConstraint {
    left-Double(right)
}

@discardableResult
func - (left: UIView, right: Int) -> PartialConstraint {
    left-Double(right)
}
...
@discardableResult
func - (left: SideConstraint, right: UIView) -> UIView {
...
@discardableResult
func - (left: [UIView], right: SideConstraint) -> [UIView] {
...
@discardableResult
func - (left: PartialConstraint, right: UIView) -> [UIView] {
...
@discardableResult
func - (left: UIView, right: String) -> Space {
...
@discardableResult
func - (left: Space, right: UIView) -> [UIView] {
